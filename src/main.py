...
from src.routers import hybrid_search, setup
from src.routers.streaming import ask_router, stream_router
...
# Include routers
app.include_router(setup.router, prefix="/api/v1")  # Health check endpoint
